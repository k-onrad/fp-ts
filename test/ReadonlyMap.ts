...
import { identity, pipe, Refinement } from '../src/function.ts'
...
import * as _ from '../src/ReadonlyMap.ts'
import { getFirstSemigroup, getLastSemigroup, getStructSemigroup, semigroupSum } from '../src/Semigroup.ts'
import { getStructShow, Show, showString } from '../src/Show.ts'
